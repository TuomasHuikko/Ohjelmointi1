"""
COMP.CS.100 "extended_person" tehtävä.
...
class Person:
    ...
    def __init__(self, name, initial_money, address):
        ...
        :param address: str, the address where the person currently lives.
        """
    ...
    def move(self, new_address):
        """
        Updates the persons address to the new given address.

        :param new_address: str, the address where the person is going to move.
        """
